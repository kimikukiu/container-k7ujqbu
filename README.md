...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k7ujqbu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k7ujqbu.containers.anotherwebservice.com/
...
```
git clone git@github.com:kimikukiu/container-k7ujqbu.git
cd container-k7ujqbu
```
...
```
docker attach container-k7ujqbu
```
